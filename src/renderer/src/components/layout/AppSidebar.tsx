...
export function AppSidebar({ onTableSelect, onKeySelect, activeMode, onModeChange }: AppSidebarProps): React.JSX.Element {
        ...
        <>
            <Sidebar className="border-r border-border">
                <div className="flex h-full min-w-0">
                    <ToolRail activeMode={activeMode} onModeChange={onModeChange} />
